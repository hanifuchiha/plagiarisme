                ...
                <div class="scroll-sidebar" style="overflow: hidden !important;">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a href="?app=abstrak" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Abstrak</span></a>

                            </li>
                            <li> <a href="?app=ujiabstrak" aria-expanded="false"><i class="fa fa-database"></i><span class="hide-menu">Data Uji Plagiarisme</a>

                            </li>
                            <li> <a href="?app=admin" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Admin</a>

                            </li>

                            </li>
                            <li> <a href="?app=pengaturan" aria-expanded="false"><i class="fa fa-gear"></i><span class="hide-menu">Pengaturan</a>
