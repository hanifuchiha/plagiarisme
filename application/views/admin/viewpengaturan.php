                    ...
                    <div class="card card-outline-success">
                            ...
                            <div class="card-body">
                                   <form action="aksi.php?app=pengaturan&act=ubah" method="post" class="form-horizontal">
                                    ...
                                    <?php
                                        foreach ($data as $datapengaturan) {
                                            # code...
                                        
                                        ?>
                                    <div class="form-body">
                                        
                                     <input type="hidden" name="id" value="<?php echo $datapengaturan->id; ?>">  
                                        <hr class="m-t-0 m-b-40">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="kgram" class="form-control" value="<?php echo $datapengaturan->kgram; ?>" placeholder="">
                                                        </div>
                                                </div>     
                                        <div class="form-group row">
                                                    <label class="control-label text-left col-md-2">Nilai Prima Rolling Hash</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="prima" class="form-control" value="<?= $datapengaturan->prima; ?>" placeholder="">
