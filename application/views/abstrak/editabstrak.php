    ...
    <body class="fix-header fix-sidebar">
        ...
        <div id="main-wrapper">
           ...
           ?>
            ...
            <div class="card-body">
                <form action="<?php echo base_url('abstrak/updateabstrak')?>" method="post" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="judul" class="form-control" placeholder="Judul" value="<?php echo $dataabstrak->judul ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-left col-md-2">Abstraksi skripsi</label>
                            <div class="col-md-10">
                                <textarea name="abstrak" class="textarea_editor form-control" rows="15" placeholder="abstraksi skripsi" style="height:300px"><?php echo $dataabstrak->abstrak ?></textarea>
                            </div>
                        </div>
